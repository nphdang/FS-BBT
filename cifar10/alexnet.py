...
parser.add_argument('--batchsize', default="512", type=str, nargs='?', help='batch size')
parser.add_argument('--epochs', default="50", type=str, nargs='?', help='epochs')
...
teacher = alexnet_model.alexnet(input_shape=img_shape, num_classes=n_class)
