...
parser.add_argument('--dataset', default="cifar10", type=str, nargs='?', help='dataset name')
...
student_model_type = 'student_light_kd'
...
if number_generate > 0:
    ...
    decoder = load_model("./{}/cvae_decoder_{}_{}_method_{}_la{}_bs{}_ep{}_teacher_{}.h5".
...
student = alexnet_model.alexnet_half(input_shape=img_shape, num_classes=n_class)
if loss_type == "ce":
