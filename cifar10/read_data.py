...
# read data from file
def from_file(dataset="cifar10", type="original", plot=False):
...
# X_train, y_train, X_test, y_test, n_train, n_test, n_feature, n_class, img_shape = from_file("cifar10", "subset", plot=True)
