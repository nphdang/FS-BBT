...
encoder.save("./{}/cvae_encoder_{}_{}_method_{}_la{}_bs{}_ep{}_teacher_{}.h5".
             format(save_folder_model, dataset, cvae_data_type, cvae_method, latent, batch_size, epochs, teacher_data_type))
decoder.save("./{}/cvae_decoder_{}_{}_method_{}_la{}_bs{}_ep{}_teacher_{}.h5".
             format(save_folder_model, dataset, cvae_data_type, cvae_method, latent, batch_size, epochs, teacher_data_type))
...
plt.savefig('./{}/cvae_loss_{}_{}_method_{}_la{}_bs{}_ep{}_teacher_{}.pdf'.
            format(save_folder_model, dataset, cvae_data_type, cvae_method, latent, batch_size, epochs, teacher_data_type),
            bbox_inches="tight")
plt.close()
...
plt.savefig('./{}/cvae_images_{}_{}_method_{}_la{}_bs{}_ep{}_teacher_{}.pdf'.
            format(save_folder_model, dataset, cvae_data_type, cvae_method, latent, batch_size, epochs, teacher_data_type),
            bbox_inches="tight")
plt.close()
...
# save result to file
with open('./{}/cvae_{}_{}_method_{}_la{}_bs{}_ep{}_teacher_{}.txt'.
                  format(save_folder_model, dataset, cvae_data_type, cvae_method, latent, batch_size, epochs, teacher_data_type), 'w') as f:
